...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
					...
					<div class="x_content">
						...
						<table class="table table-striped" id="pasien">
							...
							<tbody>
								...
								<td><a href="<?php echo $admin_url; ?>masterpasien/form_edit.php?id_pasien=<?php echo $data['id_pasien'];?>">
								<button class="btn btn-warning">
									<i class="fa fa-edit"></i>
								</button></a>
								
								<a href="<?php echo $admin_url; ?>masterpasien/hapus.php?id_pasien=<?php echo $data['id_pasien'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
			...
			<div class="col-xs-12">
				<a href="<?php echo $admin_url; ?>masterpasien/form_tambah.php">
