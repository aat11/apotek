...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<table class="table table-striped" id="resep">
							<thead>
								<tr>
									<th>No</th>
									<th>ID Resep</th>
							...
							<tbody>
								...
								<td><a href="<?php echo $admin_url; ?>masterresep/form_edit.php?id_resep=<?php echo $data['id_resep'];?>">
								<button class="btn btn-warning">
									<i class="fa fa-edit"></i>
								</button></a>
								
								<a href="<?php echo $admin_url; ?>masterresep/hapus.php?id_resep=<?php echo $data['id_resep'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
			...
			<div class="col-xs-12">
				<a href="<?php echo $admin_url; ?>masterresep/form_tambah.php">
